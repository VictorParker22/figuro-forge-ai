        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            ...
            <p className="text-white/70 text-sm">
              Creating beautiful 3D figurines from text prompts using the power of AI.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-white/70 text-sm hover:text-white transition-colors">Features</a></li>
              <li><a href="#" className="text-white/70 text-sm hover:text-white transition-colors">Pricing</a></li>
              <li><a href="#" className="text-white/70 text-sm hover:text-white transition-colors">Use Cases</a></li>
              <li><a href="#" className="text-white/70 text-sm hover:text-white transition-colors">Gallery</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-white/70 text-sm hover:text-white transition-colors">Legal</a></li>
            </ul>
          </div>
        </div>
